...
public class T16_NonSerializableParrentTest {
/**
...
class Child extends Parent implements Serializable {
	...
	/**
	 *  직렬화 될 때 자동으로 호출됨
	 *  (접근 제한자가 private이 아니면 자동호출되지 않는다.)
	 *  @param out
	 *  @throws IOException
	 */
	private void writeObject(ObjectOutputStream out) throws IOException {
		// ObjectOutputStream 개체의 메서드 이용하여 부모 객체 필드값 처리하기
	...
	private void readObject(ObjectInputStream in) throws IOException, ClassNotFoundException {
		// ObjectInputStream 객체의 메서드를 이용하여 부모객체 필드값 처리하기
