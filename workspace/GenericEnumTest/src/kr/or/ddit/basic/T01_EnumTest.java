 ...
 */
	...
	// 데이터값을 정해줄 경우에는 생성자를 만들어서 괄호 속의 값이 변수에 저장되도록 한다.
	public enum Season {
		...
		// 생성자 만들기(열거형의 생정자는 제어자가 묵시적으로 'private'이다)
	 ...
	 */
		...
		System.out.println("myCith1의 ordinal : " + myCity1.ordinal());
		System.out.println();
		
		System.out.println("myCity2 : " + myCity2.name());
		System.out.println("myCith2의 ordinal : " + myCity2.ordinal());
		System.out.println("===================================");
